...
网络协议、数据结构与算法、PHP、Web、MySQL、Redis、Linux、安全、设计模式、架构、自我介绍、离职原因、职业规划、准备问题
...
- [Vim](./QA.md#vim)
- [负载查看](./QA.md#负载查看)
- [进程、线程、协程区别](./QA.md#进程线程协程区别)

### 安全篇

- [跨站脚本攻击(XSS)](./QA.md#跨站脚本攻击xss)
- [跨站点请求伪造(CSRF)](./QA.md#跨站点请求伪造csrf)
- [SQL 注入](./QA.md#sql-注入)
- [应用层拒绝服务攻击](./QA.md#应用层拒绝服务攻击)
- [PHP 安全](./QA.md#php-安全)
- [伪随机数和真随机数](./QA.md#伪随机数和真随机数)

### 设计模式篇

- [什么是设计模式](./QA.md#什么是设计模式)
- [如何理解框架](./QA.md#如何理解框架)
- [主要设计模式](./QA.md#主要设计模式)
- [怎样选择设计模式](./QA.md#怎样选择设计模式)
- [单例模式](./QA.md#单例模式)
- [抽象工厂模式](./QA.md#抽象工厂模式)
- [工厂方法模式](./QA.md#工厂方法模式)
- [适配器模式](./QA.md#适配器模式)
...
- [OAuth 2.0](./QA.md#oauth-20)
- [单点登录](./QA.md#单点登录)
- [REST](./QA.md#rest)
- [API 版本兼容](./QA.md#api-版本兼容)
- [JWT](./QA.md#jwt)
- [画出 PHP 业务架构图](./QA.md#画出-php-业务架构图)
- [LVS](./QA.md#lvs)
- [Ngnix](./QA.md#ngnix)
- 服务化
- 微服务
- 服务注册发现
- [数据库读写分离](./QA.md#数据库读写分离)
- [数据库拆分](./QA.md#数据库拆分)
- [分布式事务](./QA.md#分布式事务)
- ID 生成器
- [一致性哈希](./QA.md#一致性哈希)
- [Redis 集群](./QA.md#redis-集群)
- 消息队列
- 穿透、雪崩
- 限流(木桶、令牌桶)
- 服务降级
